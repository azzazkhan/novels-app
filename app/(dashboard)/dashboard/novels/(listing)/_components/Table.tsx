                            ...
                            <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                <tr>
                                    ...
                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                        <button
                                            type="button"
                                            className="inline-flex items-center justify-center px-1 text-gray-500 transition-colors duration-200 rounded-lg w-7 h-7 dark:text-gray-300 hover:bg-gray-100"
                                        >
