...
const availableSpacings: Array<ReadingUtilsContextValue['paragraphSpacing']> = [
    6, 8, 10, 14, 16, 20,
];

const ParagraphSpacing: FC<Props> = ({ className }) => {
    const { paragraphSpacing, setParagraphSpacing } = useReader();
    ...
    return (
        ...
        >
            <h3 className="text-lg font-bold">Paragraph Spacing</h3>

            <Listbox value={paragraphSpacing} onChange={setParagraphSpacing}>
                <div className="relative w-32 mt-1">
                    <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-white rounded-lg shadow-md cursor-pointer sm:text-sm">
                        <span className="block truncate">{paragraphSpacing}px</span>
