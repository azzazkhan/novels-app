...
const availableTranslations: Record<ReadingUtilsContextValue['translationLanguage'], string> = {
    dutch: 'Dutch',
    english: 'English',
    espanol: 'Espanol',
    french: 'French',
...
const TranslationLanguage: FC<Props> = ({ className }) => {
    const { translationLanguage, setTranslationLanguage } = useReader();
    ...
    return (
        ...
        >
            <h3 className="text-lg font-bold">Translation Language</h3>

            <Listbox value={translationLanguage} onChange={setTranslationLanguage}>
